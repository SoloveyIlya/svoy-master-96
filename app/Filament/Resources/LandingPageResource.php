    ...
    public static function form(Form $form): Form
    {
        return $form->schema([
            Forms\Components\Tabs::make('Tabs')->tabs([
                Forms\Components\Tabs\Tab::make('Привязки')->schema([
    ...
    public static function table(Table $table): Table
    {
        return $table
            ->columns([
                ...
                Tables\Columns\TextColumn::make('brand.name')->label('Бренд'),
                Tables\Columns\TextColumn::make('deviceModel.name')->label('Модель'),
