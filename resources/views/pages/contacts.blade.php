...
@section('content')
    ...
    <section id="contacts-branches" class="max-w-[87.5rem] mx-auto px-4 py-12 scroll-mt-32">
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 items-start">
            <div class="space-y-6">
                <div class="text-2xl font-bold text-[#1A1A1A]">Наши филиалы</div>
                
                {{-- Филиал 1 --}}
                <div class="space-y-3">
                    <div class="font-bold text-[#0678A8]">Центральный офис</div>
                ...
                {{-- Филиал 2 --}}
                <div class="space-y-3">
                    <div class="font-bold text-[#0678A8]">Филиал ЖБИ</div>
                    <p class="flex items-center gap-3 text-gray-700">
                        <svg class="w-6 h-6 text-[#0678A8] shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z"></path><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z"></path></svg>
            ...
            <div class="space-y-4">
                <div class="text-2xl font-bold text-[#1A1A1A]">Связь с нами</div>
                <div class="space-y-3">
            ...
            <div class="space-y-4">
                <div class="text-2xl font-bold text-[#1A1A1A]">Мессенджеры</div>
                <div class="flex items-center gap-4">
                    <a href="https://t.me/sme0001" target="_blank" rel="noopener noreferrer" class="w-12 h-12 rounded-full bg-gradient-to-r from-[#0678A8] to-[#029DBF] flex items-center justify-center hover:opacity-90 transition shadow-md">
                        <img src="{{ asset('images/TG.svg') }}" alt="Telegram" class="w-6 h-6 object-contain" />
                    </a>
                    <a href="https://wa.me/73432264622" target="_blank" rel="noopener noreferrer" class="w-12 h-12 rounded-full bg-gradient-to-r from-[#0678A8] to-[#029DBF] flex items-center justify-center hover:opacity-90 transition shadow-md">
