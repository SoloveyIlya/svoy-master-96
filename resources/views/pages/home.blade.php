    ...
    <section class="max-w-[87.5rem] mx-auto px-4 pt-16 pb-20 grid grid-cols-1 lg:grid-cols-2 gap-8 items-center relative overflow-hidden">
        <div class="relative z-10">
            ...
            <div class="flex flex-wrap items-center gap-4">
                ...
                <a href="{{ route('contacts') }}" class="border-2 border-[#2AC0D5] text-[#2AC0D5] hover:bg-[#2AC0D5] hover:text-white font-medium py-3 px-8 rounded-full flex items-center gap-2 transition">
