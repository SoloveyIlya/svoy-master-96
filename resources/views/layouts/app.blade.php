...
<head>
    ...
    @php
        $resolvedTitle = $seoTitle ?? (trim($__env->yieldContent('title')) ?: 'Свой Мастер - Ремонт цифровой техники');
        $resolvedDescription = $seoDescription ?? (trim($__env->yieldContent('seo_description')) ?: 'Профессиональный ремонт телефонов, ноутбуков и планшетов в Екатеринбурге. Оригинальные запчасти, гарантия до 2 лет.');
        $resolvedOgTitle = $seoTitle ?? (trim($__env->yieldContent('og_title')) ?: $resolvedTitle);
        $resolvedOgDescription = $seoDescription ?? (trim($__env->yieldContent('og_description')) ?: $resolvedDescription);
    @endphp
