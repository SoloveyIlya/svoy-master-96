    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-8">
            <div>
                ...
                <div class="font-bold text-lg mb-2">С 2017 года</div>
            ...
            <div>
                ...
                <div class="font-bold text-lg mb-2">Ремонт в вашем присутствии</div>
            ...
            <div>
                ...
                <div class="font-bold text-lg mb-2">Запчасти высокого качества</div>
            ...
            <div>
                ...
                <div class="font-bold text-lg mb-2">Честная цена</div>
